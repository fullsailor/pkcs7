...
func TestVerifyAzureAttestedMetadata(t *testing.T) {
	fixture := UnmarshalTestFixture(AzureAttestedMetadataFixture)
	p7, err := Parse(fixture.Input)
	if err != nil {
		t.Errorf("Parse encountered unexpected error: %v", err)
	}
...
var AzureAttestedMetadataFixture = `
-----BEGIN PKCS7-----

...

-----END PKCS7-----`
